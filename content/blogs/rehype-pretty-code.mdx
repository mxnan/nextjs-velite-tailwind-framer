...
description: Use Cases for rehype-pretty-code and testing capabilities of shiki.
date: "2024-07-15"
status: "published"
...
Fully test the capabilities of rehype pretty code and see what can i do with it
...
```js showLineNumbers {2-4} title="isEven.js" /console/
