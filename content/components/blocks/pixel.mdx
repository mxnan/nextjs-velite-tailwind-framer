---
title: Pixel Grid effect
description: pixel grid cursor hero section
category: blocks
tags: ["blocks", "pixel","cursor"]
---

---

- Used WobbleCard again , find on [aceternityUI](https://ui.aceternity.com/components/wobble-card)
- Read a blog on this effect , will add text-blend to it also .
...
<ComponentPreview path="pixel-grid" category="blocks" usingCN  />
</TabsContent>
