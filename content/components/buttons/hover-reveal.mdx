...
const GithubStar = () => {
  ...
  return (
    <section className="w-full h-80 flex-1 flex items-center justify-center">
     ...
     bg-primary *:font-semibold overflow-hidden group/button
     border border-primary"
        >
          <span className="flex items-center text-lg text-primary-foreground gap-1">
            Find Repo ?{" "}
            <svg
         ...
         "
          ...
          <span className="relative px-2 py-1 flex items-center gap-2">
            ...
            />
            <motion.span className="text-primary z-20" variants={textVariant}>
