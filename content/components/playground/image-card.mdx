...
/>
> Image and wobbleCard reveal animation

Wobble Card taken from [aceternityUI](https://ui.aceternity.com/components/wobble-card) and tweaked a little
...
`you can find wobblecard in github repo`
